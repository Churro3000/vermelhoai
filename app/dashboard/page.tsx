            ...
            <form onSubmit={handleSubmitAudit} className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-2.5 flex items-start gap-2">
                  <svg className="w-3.5 h-3.5 text-[#00A651] shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
                  </svg>
                  <p className="text-gray-400 text-xs leading-relaxed">
                    Your API key is <span className="text-gray-600 font-medium">never stored</span> — encrypted in transit, used strictly to execute the audit via serverless functions, and wiped from memory immediately after.
                  </p>
                </div>

                {/* Security tip */}
                <div className="mt-2.5 bg-[#F8F8F5] border border-gray-200 rounded-lg px-3 py-2.5">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-gray-400 text-xs leading-relaxed">
                      <span className="text-gray-600 font-medium">Security tip:</span> For maximum safety, create a temporary API key in your AI provider dashboard with a $1.00 spend limit, and delete it immediately after your audit report is generated.
                    </p>
                  </div>
                </div>
              </div>
