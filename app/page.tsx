        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-10 pt-6 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="https://www.linkedin.com/company/vermelho-ai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-gray-600 hover:text-white transition-colors text-xs font-medium">
